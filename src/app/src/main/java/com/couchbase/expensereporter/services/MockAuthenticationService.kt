...
class MockAuthenticationService
    ...
    init {
        ...
        _mockUsers["demo7@example.com"] = User("demo7@example.com", "P@ssw0rd12", "HR")
        _mockUsers["demo8@example.com"] = User("demo8@example.com", "P@ssw0rd12", "HR")
        _mockUsers["demo9@example.com"] = User("demo9@example.com", "P@ssw0rd12", "HR")
        _mockUsers["demo10@example.com"] = User("demo10@example.com", "P@ssw0rd12", "IT")
        _mockUsers["demo11@example.com"] = User("demo11@example.com", "P@ssw0rd12", "IT")
        _mockUsers["demo12@example.com"] = User("demo12@example.com", "P@ssw0rd12", "IT")
        _mockUsers["demo13@example.com"] = User("demo13@example.com", "P@ssw0rd12", "IT")
        _mockUsers["demo14@example.com"] = User("demo14@example.com", "P@ssw0rd12", "IT")
        _mockUsers["demo15@example.com"] = User("demo15@example.com", "P@ssw0rd12", "IT")
    }
}