...
filename="managers.json" #data file
dbFileName='starting.cblite2' #database file

length=20 # only get 20 items to put in the database
...
do
	...
	idIndex=".managerId" #get the field that we want to use as the document id 
